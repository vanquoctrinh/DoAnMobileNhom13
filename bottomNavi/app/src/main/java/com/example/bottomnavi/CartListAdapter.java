...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public CartListAdapter(ArrayList<FoodDomain> foodDomains,Context context ,ManagementCart managementCart, ChangeNumberItemsListener changeNumberItemsListener) {
    ...
    public void onBindViewHolder(@NonNull CartListAdapter.ViewHolder holder, int position) {
        ...
        holder.feeEachItem.setText(String.valueOf(foodDomains.get(position).getMoney()));
        holder.totalEachItem.setText(String.valueOf(Math.round((foodDomains.get(position).getNumberInCart()*foodDomains.get(position).getMoney())*100)/100));
